namespace Terrasoft.Configuration.DataForge
{
	...
	public interface IDataForgeService
	{
		...
		/// <param name="cancellationToken">Cancellation token for the operation.</param>
		void DeleteLookup(Entity entity, CancellationToken cancellationToken = default);
	...
	public class DataForgeService : IDataForgeService
	{
		...
		/// <inheritdoc/>
		public void DeleteLookup(Entity entity, CancellationToken cancellationToken = default) {
			try {
				var id = entity.GetTypedColumnValue<Guid>("Id");
